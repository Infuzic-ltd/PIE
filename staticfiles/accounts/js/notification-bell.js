...
(function () {
  ...
  // Browsers refuse to produce sound from an AudioContext until the page has
  // seen a real user gesture — warm it up on the first click/key/touch so it's
  // already running by the time a notification actually needs to play.
  ['click', 'keydown', 'touchstart'].forEach(function (evt) {
    document.addEventListener(evt, ensureAudioContext, { passive: true });
  });
